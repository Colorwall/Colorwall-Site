...
export const ComparisonTable = ({ theme, isDownloadPage = false }: { theme: "dark" | "light", isDownloadPage?: boolean }) => {
    ...
    const features = [
        ...
        },
        {
            ...
            desc: "Auto-pauses on full-screen games and battery mode. Built to step out of your way.",
            icon: Zap,
            colSpan: "lg:col-span-1",
        },
        {
            title: "Shaders & Particles",
            desc: "Real-time HLSL effects—reflections, sway, chromatic aberration, blur, and raindrops. All GPU-accelerated.",
            icon: Wand2,
            tag: "UNDER DEV",
            colSpan: "lg:col-span-1",
        },
    ...
    return (
        <section className={`${isDownloadPage ? "py-0 px-0" : "px-4 sm:px-8 pt-8 pb-16"} relative overflow-hidden`}>
            {!isDownloadPage && (
                            ...
                            <div className="relative w-full">
                                ...
                                <div className="relative z-10 pointer-events-none">
                                    <p className={`text-[11px] font-mono tracking-[0.3em] uppercase mb-8
                                      ...
                                      {isDownloadPage ? "What you're getting" : "How do we compare?"}
                                    </p>
                                    ...
                                    <GradientHeading
                                        ...
                                        theme={theme}
                                        className="text-4xl md:text-5xl lg:text-6xl font-outfit font-bold tracking-widest uppercase"
                                    />
                                </div>
                            </div>
            ...
            <div className={`max-w-[100rem] mx-auto relative z-10 ${isDownloadPage ? "mt-0 px-0" : "mt-12 px-2 lg:px-8"}`}>
