...
export function HeroInteractive() {
    ...
    return (
        <div className="flex flex-col items-start sm:items-center lg:items-end gap-2 w-full">
            <div className="flex flex-wrap items-center justify-start lg:justify-end gap-2.5 sm:gap-3 w-full sm:w-auto">
                {/* download */}
