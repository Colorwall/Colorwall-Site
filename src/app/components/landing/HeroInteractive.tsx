        ...
        <div className="flex flex-col items-start lg:items-end gap-3 w-full lg:w-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 w-full sm:w-auto">
                ...
                >
                    ...
                    Discord <span className="font-mono text-indigo-300/80 bg-indigo-500/20 px-1.5 py-0.5 rounded text-[10px]">{socialMetrics.discord}</span>
                </a>
                ...
                >
                    ...
                    Stars <span className="font-mono text-white/70 bg-white/10 px-1.5 py-0.5 rounded text-[10px]">{socialMetrics.github}</span>
                </a>
