...
import { Github, MessageCircle, Moon, Sun, Home, Download, FileText } from "lucide-react";
...
export const Navbar = () => {
    ...
    return (
        <>
            {/* ── desktop: vertical side dock (hidden on mobile) ── */}
            <motion.div
            ...
            {/* ── mobile: floating bottom pill (hidden on md+) ── */}
            <motion.div
            ...
            >
                ...
                >
                    ...
                    <Link
                        href="/"
                        className={`flex flex-col items-center justify-center w-12 h-12 rounded-full transition-all duration-200 active:scale-90
                            ${pathname === "/"
                                ? (isDark ? "bg-white/10" : "bg-black/5")
                                : ""}`}
                    >
                        <img src="/colorwall.png" alt="Home" className="w-5 h-5 object-contain" />
                    </Link>
